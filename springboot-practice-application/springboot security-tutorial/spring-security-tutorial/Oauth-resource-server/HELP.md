...
* The original package name 'com.codingspiderverse.Oauth-resource-server' is invalid and this project uses 'com.codingspiderverse.Oauthresourceserver' instead.
...
* [OAuth2 Resource Server](https://docs.spring.io/spring-boot/docs/3.1.6/reference/htmlsingle/index.html#web.security.oauth2.server)
